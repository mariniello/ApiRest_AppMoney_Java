...
import com.AppMoney_Api.model.Categoria_;
import com.AppMoney_Api.model.Lancamento;
import com.AppMoney_Api.model.Lancamento_;
import com.AppMoney_Api.model.Pessoa_;
import com.AppMoney_Api.repository.filter.LancamentoFilter;
import com.AppMoney_Api.repository.projection.ResumoLancamento;
	...
	private Predicate[] criarRestricoes(LancamentoFilter lancamentoFilter, CriteriaBuilder builder,
		...
		if (!StringUtils.isEmpty(lancamentoFilter.getDescricao())) {
			...
			predicates.add(builder.like(
					builder.lower(root.get(Lancamento_.descricao)), "%" + lancamentoFilter.getDescricao().toLowerCase() + "%"));// o símbolo "%" para ele poder fazer a
